        ...
        {!loading && !error && (
          <div className='grid md:grid-cols-3 gap-10'>
             <div className='pb-[50px] px-[30px] rounded-md'>
              ...
              {/*________________________________ Part of text ______________________________________ */}
              ...
              {/*__________________________________Part of button____________________________________________ */}
            ...
            {/*___________________________________Part of Button function__________________________________________________ */}
             <div className='md:col-span-2 md:px-[30px]'>
                ...
                {/*_______________________________ Access for both pages _____________________________ */} 
